...
<h3>IndoLoom</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> "IndoLoom" is an online shopping website that brings all the artwork and designs from the remote villages of India at a place, allowing all the people to own these pieces of art from the comfort of their homes.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">getsetgo@handlooms.com</a></span>
                </div>
            </li>
